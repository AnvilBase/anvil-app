...
enum ToolRequirement: Sendable {
  ...
  case memory
  /// Only with the picture model installed and Anvil Pro active.
  ...
  var label: String {
    ...
    case .imageGeneration: "When an image model is installed and on, and Pro is active"
    }
  }
}
...
enum ToolRegistry {
  ...
  private static let shared: [ToolEntry] = [
    ...
    ToolEntry(
      ...
      summary: "Makes a picture on this iPhone. Part of Anvil Pro.",
