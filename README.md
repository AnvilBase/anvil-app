...
`Sources/Engine/ModelPlan.swift` is the reading of the catalog every screen uses: one plan per
model, in the catalog's order.
...
| Anvil Dream (`anvil-dream`, Pro, pictures, 1024 px, phones with 12 GB of memory) | 3.02 GB | [CreativeML Open RAIL++-M](https://github.com/Stability-AI/generative-models/blob/main/model_licenses/LICENSE-SDXL1.0) |
